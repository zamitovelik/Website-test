...
через прокси Vite. Чтобы получать заявки, запустите в папке `backend` один из мастеров настройки:
...
Telegram проще: не нужны ни пароли приложений, ни двухэтапная проверка.
Каналы можно включить оба сразу.
...
| `/leads` | Заявки с сайта — только для вошедших |
